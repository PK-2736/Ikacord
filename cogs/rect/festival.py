...
class festival(commands.Cog):
    ...
    async def festival(self, interaction: discord.Interaction):
        if interaction.channel.id not in [1021723476870058094,1021723008626339852,1021722171183218719,982602254278357022, 981474117020712973, 1007288564247179347, 1011555949837824001, 1011556210719338537, 1011556131786735677, 802345513495822339, 982602254278357022]:
            return await interaction.respond("エラー：フェス募集コマンドを実行出来るのは <#1021723476870058094>,<#1021723008626339852>,<#1021722171183218719> です!。")
