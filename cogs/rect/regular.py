...
class regular(commands.Cog):
    ...
    async def rectregular(self, interaction: discord.Interaction):
        if interaction.channel.id not in [981474117020712973, 1027901079368761426]:
            return await interaction.respond("エラー：レギュラー募集コマンドは <#1027901079368761426> で実行して下さい。",ephemeral = True)
