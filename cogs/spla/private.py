...
class MyModalp(discord.ui.Modal):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed.add_field(name="参加者", value=f"{interaction.user.mention} {datetime.now().strftime('%m/%d %H:%M')}", inline=False)
...
class private(commands.Cog):
    ...
    @slash_command(guild_ids=guild_ids, description="プライベートマッチメンバーの募集")
    async def 募集プラベ(self, interaction: discord.Interaction):
