...
class regul(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot

    @slash_command(guild_ids=guild_ids, description="レギュラーマッチメンバーの募集")
    async def 募集レギュラー(self, interaction: discord.Interaction):
